...
const testimonials = [
  {
    quote: "Vaidya helped me understand my Vata imbalance and suggested herbs that truly transformed my sleep and digestion.",
    author: "Priya Sharma",
    role: "Yoga Instructor",
    company: "Wellness Seeker",
    metric: { value: "3", label: "Doshas balanced" },
  },
  {
    quote: "The depth of knowledge from ancient texts is remarkable. It feels like consulting with a traditional Vaidya.",
    author: "Dr. Anand Kulkarni",
    role: "Ayurvedic Practitioner",
    company: "Kerala Ayurveda",
    metric: { value: "108", label: "Texts referenced" },
  },
  {
    quote: "I finally understand my Prakriti and how to live in harmony with my constitution. This is authentic Ayurveda.",
    author: "Maya Patel",
    role: "Health Enthusiast",
    company: "Spiritual Seeker",
    metric: { value: "5000+", label: "Years of wisdom" },
  },
  {
    quote: "Every herb recommendation comes with citations from Charaka Samhita. The authenticity gives me confidence.",
    author: "Ravi Krishnan",
    role: "Herbalist",
    company: "Traditional Healer",
    metric: { value: "500+", label: "Herbs documented" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Seekers finding
              <span className="text-background/40"> balance.</span>
            </h2>
          </div>
