...
Python API: RAG retrieval (Chroma + local sentence-transformers), dual `gpt-4o-mini` agents (session query + grounded answer), PostgreSQL chat history, optional Redis embedding cache.
